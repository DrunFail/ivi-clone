...
type BudgetType = 'BUDGET' | 'MARKETING' | 'RUS' | 'USA' | 'WORLD';
...
type TrailerType = 'YOUTUBE' | 'KINOPOISK_WIDGET' | 'UNKNOWN';
...
export type MovieSortBy = 'nameRu' | 'year' | 'ratingKinopoiskVoteCount' | 'ratingKinopoisk';
