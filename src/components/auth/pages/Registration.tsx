    ...
    return (
        <form action={action} noValidate>
            ...
            <TextFieldErrorMessage error={state?.errors.email && t(`auth.error.${state.errors.email}`)}>
                <TextFieldWithLabel id="email" name="email" type="email" labelText={t('auth.label.email')} />
            </TextFieldErrorMessage>
            <TextFieldErrorMessage error={state?.errors.password && t(`auth.error.${state.errors.password}`)}>
                <TextFieldWithLabel id="password" name="password" type="password" labelText={t('auth.label.pwd')} />
            </TextFieldErrorMessage>

            <TextFieldErrorMessage
                error={state?.errors.confirmPassword && t(`auth.error.${state?.errors.confirmPassword}`)}
            >
                <TextFieldWithLabel
                    id="confirmPassword"
