...
export default function DropdownFilter({ filterKey, variants, defaultValue, selectedValue, isSetCurrentValue = false, filterName }: DropdownFilterProps) {
    return (
        <DropdownFilterContainer filterKey={filterKey} isSetCurrentValue={isSetCurrentValue}>
            ...
            />
            <PositionContainer
                id={`variants-${filterKey}`}
                style={{ display: "none", inlineSize: "max-content" }}
            >
