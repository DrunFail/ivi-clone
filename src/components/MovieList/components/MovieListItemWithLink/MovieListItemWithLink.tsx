    ...
    return (
        <Link href={`/movie/${elem.kinopoiskId}`}>
            <MovieListItem elem={elem}>
                <OverlayMovieListItem elem={elem}>
                    <ButtonActionOverlay description={"Смотреть позже"}>
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.75 5H8.25C7.55964 5 7 5.58763 7 6.3125V19L12 15.5L17 19V6.3125C17 5.58763 16.4404 5 15.75 5Z" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" /></svg>
                    </ButtonActionOverlay>

                    <ButtonActionOverlay description={"Похожее"}>
                        <svg width="20px" height="20px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">

                            <g id="magic" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
                                <rect width="48" height="48" fill="white" fillOpacity="0.01" />
                                <g id="编组" transform="translate(5.000000, 4.000000)" stroke='white' strokeWidth="4">
                                    <path d="M25,0 L25,6 M34.8994949,4.10050506 L30.6568542,8.34314575 M39,14 L33,14 M34.8994949,23.8994949 L30.6568542,19.6568542 M25,28 L25,22 M15.1005051,23.8994949 L19.3431458,19.6568542 M11,14 L17,14 M15.1005051,4.10050506 L19.3431458,8.34314575" id="Path-299"></path>
                                    <path d="M24.5857864,14.4142136 L0.544155877,38.4558441" id="Path-300" transform="translate(12.564971, 26.435029) rotate(-0.000000) translate(-12.564971, -26.435029) "></path>
                                </g>
                            </g>
                        </svg>
                    </ButtonActionOverlay>
