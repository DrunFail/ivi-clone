...
export default function SupportBlockButton({ variant }: { variant: 'desktop' | 'tablet' | 'mobile' }) {
    ...
    return (
        <div className={defaultClasses} data-testid="btns-support-block">
            <Button as="button">{t('WriteInChat')}</Button>
            <Button as="button" size="mini" aria-label="телефон поддержки">
                <FontIcon variant="phone" />
            </Button>

            <Button as="button" size="mini" aria-label="написать электронное письмо в поддержку">
