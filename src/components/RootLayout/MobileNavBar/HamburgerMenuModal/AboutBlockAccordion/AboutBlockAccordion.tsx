...
export default function AboutBlockAccordion() {
    ...
    return (
        <AccordionItem
            heading={<NavigationBlockTitle>{t(`footer.${FOOTER_NAV_MENU[0].name}`)}</NavigationBlockTitle>}
            content={
                <div style={{ marginBlockStart: '20px' }}>
                    <DropdownList linkDataList={FOOTER_NAV_MENU[0].data.menu} intlPrefix="footer" oneColumn />
                </div>
            }
