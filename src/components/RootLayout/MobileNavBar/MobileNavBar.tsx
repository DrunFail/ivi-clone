        ...
        <div className={styles.container}>
            <div className={styles.content}>
                <Button onlyImage as="link" href="/">
                    <MobileNavBarItemNew variant="home">{t('MyIvi')}</MobileNavBarItemNew>
                </Button>

                <Button onlyImage as="link" href="/movies">
                    <MobileNavBarItemNew variant="tv">{t('Catalog')}</MobileNavBarItemNew>
                </Button>

                <SearchButtonWithModal
                    button={
                        <Button onlyImage>
                            <MobileNavBarItemNew variant="search">{t('Search')}</MobileNavBarItemNew>
                        </Button>
                    }
                    modal={<SearchModal />}
                />
                ...
                <Button onlyImage as="link" href="https://www.ivi.ru/tvplus">
                    <MobileNavBarItemNew variant="tv">{t('Tv+')}</MobileNavBarItemNew>
                </Button>
                <HamburgerMenuButtonWithModal
                    modal={<HamburgerMenuModal navMenu={navMenu} />}
                    closeBtn={<MobileNavBarItemNew variant={'close'}>{t('Close')}</MobileNavBarItemNew>}
                    openBtn={<MobileNavBarItemNew variant={'dots'}>{t('More')}</MobileNavBarItemNew>}
                />
            </div>
        </div>
    );
