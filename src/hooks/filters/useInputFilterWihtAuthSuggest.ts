...
export default function useInputFilterWithAutoSuggest({setFilterParams, filterKey,currentId }:UseInputFilterWithAutoSuggestProps) {
    ...
    return {inputContainerRef, selected,handleClearParams, queryParams, handleChange, handleFocus, isOpen, suggestions, handleClick}
}