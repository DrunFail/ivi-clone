    ...
    return (
        <MoviePageModal>
            <MoviePageModalLayout movie={movie} dict={dict} lang={locale}>
                <CreatersTab>
                    <CreatersPersonList personList={actorList} listTitle={dict.actors} />
                    <CreatersPersonList personList={directorList} listTitle={dict.director} />
                    <CreatersPersonList personList={writerList} listTitle={dict.actors} />
                </CreatersTab>
